// Minimal service worker for RCN Ops Map (static site)
...
self.addEventListener('fetch', (event) => {
  ...
  // Same-origin: try cache first, fall back to network
  ...
  // Runtime cache for map tiles & Wikimedia images (stale-while-revalidate)
  ...
  // Default: go to network (e.g., YouTube)
